  ...
  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden font-sans">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Top Header */}
        <header className="h-14 bg-white/50 backdrop-blur-md border-b border-slate-200/60 flex items-center justify-between px-6 shrink-0">
          <div className="flex items-center gap-2 text-sm">
            <Link 
              href="/" 
              className="text-slate-500 font-medium hover:text-slate-950 transition-colors"
            >
              Projects
            </Link>
